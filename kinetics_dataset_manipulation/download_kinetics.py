...
def construct_video_filename(row, videos_dir, trim_format='%06d'):
...
def create_categ_csv(output_dir, behaviors, subcategory, filename, downloaded, log):
    ...
    if behaviors:
        #find the matching category and behavior
        matching_categ = [category for category, behavior in data_dict.items() if subcategory in behavior]
...
def main(input_csv, output_dir,
         ...
         drop_duplicates=False, behaviors=True):
