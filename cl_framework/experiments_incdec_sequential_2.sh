...
for i in 1 2 
do
    python -u ./data_incdec_framework/cl_framework/main.py -op runs_trainings/from_checkpoint_sgd/fd/decremental/seed_$i/ \
...
for i in 1 2 
do
    python -u ./data_incdec_framework/cl_framework/main.py -op runs_trainings/from_checkpoint_sgd/fd/joint_incremental/seed_$i/ \
