...
for i in 1 2 
do
    python -u ./data_incdec_framework/cl_framework/main.py -op runs_trainings/from_checkpoint_sgd/no_freeze/incremental_decremental/4_4_lr/seed_$i/ \
...
for i in 1 2 
do
    python -u ./data_incdec_framework/cl_framework/main.py -op runs_trainings/from_checkpoint_sgd/no_freeze/data_substitution/seed_$i/ \
