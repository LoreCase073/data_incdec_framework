...
for i in 0 1 2 
do
    python -u ./data_incdec_framework/cl_framework/main.py -op runs_trainings/freeze_backbone/baseline_multiclass/normal/seed_$i/ \
        ...
        --epochs 100 --batch_size 4 --lr_first_task 1e-3 --head_lr 1e-3 --backbone_lr 1e-3 \
