...
for i in 0 
do
    python -u ./data_incdec_framework/cl_framework/main.py -op runs_trainings/from_checkpoint_200/no_freeze/incremental_decremental/bn_frozen/4_5_lr/seed_$i/ \
        ...
        --behaviors_check yes --backbone movinetA0 --pretrained_path ./checkpoint_adam.pt
done